# WeWard - Case Study - Datascientist

Ce repository contient l'ensemble des matériaux nécessaires pour réaliser le cas pratique pour le stage de Datascientist de WeWard.

Pour réaliser ce cas technique, tu dois suivre les étapes suivantes:

### 1. Accès à l'environnement de travail

Pour démarrer ton travail, tu peux cliquer sur le bouton suivant : [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/WeWard-SAS/hiring-datascience.git/master)
...
![script-notebook](images/script_notebook.png)
...
Pour cela il te suffit de clicker sur "File" > "Download" comme montré ci-dessous:
...
Tu peux ensuite nous l'envoyer à l'adresse tanguy@weward.fr
